 enum ApplicationConfig
{
  ...
  APP_CONFIG_BASE_DATE(
		    "ami.pipeline.config.base_date"),
  APP_CONFIG_LIMITROWS(
		    "ami.pipeline.config.limit_rows"),
  ...
  APP_CONFIG_BATCH_LIMIT(
			    "ami.pipeline.config.batch_limit");
